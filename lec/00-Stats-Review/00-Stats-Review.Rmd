...
```{r NormalExAfter2, echo=F, include=T, out.width='60%'}
par(mar=c(1,1,0,0)*2)
...
knitr::kable(df, format='latex', booktabs=T, align='c') %>%
  save_kable(height=3, file='img/setupInferenceExampleTable.png')
```
]
...
**Now is the time to visit office hours**. Some, maybe even a majority, can be perplexing - this is normal and expected.
