...
1. [Create a template](#set1). Here package points to project directory: `r here()`

2. [Talk about the template](#set2). But working directory is `r getwd()`

3. [Conclude the section](#set3). All references are relative to .rmd file
...
knitr::kable(head(df %>% dplyr::select(wage, educ)), format = 'latex') %>%
  as_image(file = 'wol2.png', width=4)  # should always be calling xetex from MikTex not Tex Live! cmd > where xetex or where xelatex will show where its pointing. 
